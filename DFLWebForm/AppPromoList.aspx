<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="AppPromoList.aspx.cs" Inherits="DFLWebForm.AppPromoList" %>
            ...
            <div class="col-xs-12">
                <div class="box">
                    <div class="box-header">
                        <h3 class="box-title">Elenco Promozioni Attive</h3>
                        <p class=""></p>
                    </div>
                    <!-- /.box-header -->
                    <div class="box-body">
                        ...
                        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                            ...
                            <%--    PZTCD, PZTDE, PZTD1, PZTDI, PZTDF, PZTID--%>
                                ...
                                <ej:Grid ID="Grid" runat="server" AllowFiltering="True" EnableViewState="False" AllowPaging="True" AllowSorting="True">
                                    ...
                                    <Columns>
                                        ...
                                        <ej:Column HeaderText="Attivo" Template="#columnTemplate2" TextAlign="Center" Width="110"   />
